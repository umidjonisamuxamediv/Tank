...
import rasim from '../../../img/img(6).png'
import rasim1 from '../../../img/image 285(3).png'
...
import Variant from './componentys/Vairiant';
...
const Tanks = () => {
  ...
  return (
    <div className='bg-[#252C2C] w-full'>
    <div className='p-2 md:w-[70%] md:ml-[15%] mt-5 pt-5 pb-9 flex flex-col md:flex-row'>
      <div className='flex flex-col md:flex-row '>
        ...
        <div className='flex flex-col  '>
            ...
            {conrtys.map((el)=>(
                <div className='text-[#FFFFFF] text-[40px] ' key={el.id}>{el.tank2}</div>
            ))}
            {conrtys.map((el)=>(
                <div className='text-[#FFFFFF] text-[30px]' key={el.id}>{el.sum2}</div>
            ))}
            ...
            <button className='pt-4 pb-4 pl-4   mt-5 bg-[#FF9549] rounded-[10px] flex justify-center'>
            {conrtys.map((el)=>(
